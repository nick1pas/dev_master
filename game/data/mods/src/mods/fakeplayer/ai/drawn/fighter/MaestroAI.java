...
public class MaestroAI extends CombatBehaviorAI
{
	
	
	public MaestroAI(FakePlayer character)
	{
		super(character);
		LoadSkills();
	...
	{
		combo = new SkillCombo(new SkillAction(getBestSkill(100)));
	}
}
