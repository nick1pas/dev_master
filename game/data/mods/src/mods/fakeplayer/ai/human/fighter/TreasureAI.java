...
public class TreasureAI extends CombatBehaviorAI
{
	
	
	public TreasureAI(FakePlayer character)
	{
		super(character);
		LoadSkills();
	}
	...
	{
		combo = new SkillCombo(new SkillAction(getBestSkill(358)), new SkillAction(getBestSkill(344)), new SkillAction(getBestSkill(263)), new SkillAction(getBestSkill(30)));
	}
