...
public class MysticMuseAI extends CombatBehaviorAI
{
	...
	{
		combo = new SkillCombo(new SkillAction(getBestSkill(1235)), new SkillAction(getBestSkill(1340)), new SkillAction(getBestSkill(1342)));
	}
