...
public class DMEvent
{
	...
	public static boolean startFight()
	{
		...
		for (DMPlayer player: _dmPlayer.values())
		{
			if (player != null)
			{
			//	if (DMConfig.ENABLE_DM_INSTANCE)
			//		player.getPlayer().setInstanceId(DMConfig.DM_INSTANCE_ID, true);
...
//			return;
//
//	//	if (Config.ACTIVE_MISSION_DM)
//	//	{							
//	//		if (!activeChar.checkMissions(activeChar.getObjectId()))
//	//			activeChar.updateMissions()
//
//	//		if (!(activeChar.isDMCompleted() || activeChar.getDMCont() >= Config.MISSION_DM_COUNT))
//	//			activeChar.setDMCont(activeChar.getDMCont() + 1);
//	//	}
//		
//		switch (pos)
//		{
//		    case 1:
//	    		for (RewardHolder reward : DMConfig.DM_EVENT_REWARDS_WIN_1ST)
//	    		{
...
//								activeChar.addItem("DM 1st Reward", reward.getRewardId(), (int) (Rnd.get(reward.getRewardMin(), reward.getRewardMax()) * Config.VIP_DROP_RATE), activeChar, true);
...
//			    break;
//		    case 2:
//	    		for (RewardHolder reward : DMConfig.DM_EVENT_REWARDS_WIN_2ND)
//	    		{
//	    			if (Rnd.get(100) <= reward.getRewardChance())
//	    			{
//	    				if (activeChar.isVip())
//						{
//							if (reward.getRewardId() == 5556)
//								activeChar.addItem("DM 2nd Reward", reward.getRewardId(), (int) (Rnd.get(reward.getRewardMin(), reward.getRewardMax()) * Config.VIP_DROP_RATE), activeChar, true);
//							else if (reward.getRewardId() == 5556)
//								activeChar.addItem("DM 2nd Reward", reward.getRewardId(), (int) (Rnd.get(reward.getRewardMin(), reward.getRewardMax()) * Config.VIP_DROP_RATE), activeChar, true);
//							else
...
//			    break;
//		    case 3:
//	    		for (RewardHolder reward : DMConfig.DM_EVENT_REWARDS_WIN_3RD)
//	    		{
//	    			if (Rnd.get(100) <= reward.getRewardChance())
//	    			{
//	    				if (activeChar.isVip())
//						{
//							if (reward.getRewardId() == 5556)
//								activeChar.addItem("DM 3rd Reward", reward.getRewardId(), (int) (Rnd.get(reward.getRewardMin(), reward.getRewardMax()) * Config.VIP_DROP_RATE), activeChar, true);
//							else if (reward.getRewardId() == 5556)
//								activeChar.addItem("DM 3rd Reward", reward.getRewardId(), (int) (Rnd.get(reward.getRewardMin(), reward.getRewardMax()) * Config.VIP_DROP_RATE), activeChar, true);
//							else
...
//			    break;		    
//			 case 4:
//		    	for (RewardHolder reward : DMConfig.DM_EVENT_REWARDS_WIN_4TH)
//		    	{
//		    		if (Rnd.get(100) <= reward.getRewardChance())
//		    		{
//		    			if (activeChar.isVip())
//						{
//							if (reward.getRewardId() == 5556)
//								activeChar.addItem("DM 4th Reward", reward.getRewardId(), (int) (Rnd.get(reward.getRewardMin(), reward.getRewardMax()) * Config.VIP_DROP_RATE), activeChar, true);
//							else if (reward.getRewardId() == 5556)
//								activeChar.addItem("DM 4th Reward", reward.getRewardId(), (int) (Rnd.get(reward.getRewardMin(), reward.getRewardMax()) * Config.VIP_DROP_RATE), activeChar, true);
//							else
...
//				break;		    
//			 case 5:
//			    for (RewardHolder reward : DMConfig.DM_EVENT_REWARDS_WIN_5TH)
//			    {
//			    	if (Rnd.get(100) <= reward.getRewardChance())
//			    	{
//			    		if (activeChar.isVip())
//						{
//							if (reward.getRewardId() == 5556)
//								activeChar.addItem("DM 5th Reward", reward.getRewardId(), (int) (Rnd.get(reward.getRewardMin(), reward.getRewardMax()) * Config.VIP_DROP_RATE), activeChar, true);
//							else if (reward.getRewardId() == 5556)
//								activeChar.addItem("DM 5th Reward", reward.getRewardId(), (int) (Rnd.get(reward.getRewardMin(), reward.getRewardMax()) * Config.VIP_DROP_RATE), activeChar, true);
//							else
...
//			 case 9:
//			 case 10:
//				    for (RewardHolder reward : DMConfig.DM_EVENT_REWARDS_WIN_5AFT)
//				    {
//				    	if (Rnd.get(100) <= reward.getRewardChance())
//				    	{
//				    		if (activeChar.isVip())
//							{
//								if (reward.getRewardId() == 5556)
//									activeChar.addItem("DM 5AFT Reward", reward.getRewardId(), (int) (Rnd.get(reward.getRewardMin(), reward.getRewardMax()) * Config.VIP_DROP_RATE), activeChar, true);
//								else if (reward.getRewardId() == 5556)
//									activeChar.addItem("DM 5AFT Reward", reward.getRewardId(), (int) (Rnd.get(reward.getRewardMin(), reward.getRewardMax()) * Config.VIP_DROP_RATE), activeChar, true);
//								else
...
//	}
	private static void rewardPlayer(DMPlayer p, int pos)
	{
		...
		{
			case 1:
				rewards = DMConfig.DM_EVENT_REWARDS_WIN_1ST;
				rewardLabel = "DM 1st Reward";
				break;
			case 2:
				rewards = DMConfig.DM_EVENT_REWARDS_WIN_2ND;
				rewardLabel = "DM 2nd Reward";
				break;
			case 3:
				rewards = DMConfig.DM_EVENT_REWARDS_WIN_3RD;
				rewardLabel = "DM 3rd Reward";
				break;
			case 4:
				rewards = DMConfig.DM_EVENT_REWARDS_WIN_4TH;
				rewardLabel = "DM 4th Reward";
				break;
			case 5:
				rewards = DMConfig.DM_EVENT_REWARDS_WIN_5TH;
				rewardLabel = "DM 5th Reward";
				break;
			case 6:
			case 7:
			case 8:
			case 9:
			case 10:
				rewards = DMConfig.DM_EVENT_REWARDS_WIN_5AFT;
				rewardLabel = "DM 5AFT Reward";
				break;
			default:
				return;
		}
		...
		giveRewards(activeChar, rewards, rewardLabel);
	...
	private static void giveRewards(Player player, List<RewardHolder> rewards, String source)
	{
		for (RewardHolder reward : rewards)
		{
			if (Rnd.get(100) <= reward.getRewardChance())
			{
				...
				if (player.isVip())
					amount *= Config.VIP_DROP_RATE;

				player.addItem(source, reward.getRewardId(), amount, player, true);
			}
		}
	}
	...
	public static void stopFight()
	{
		...
		for (DMPlayer player : _dmPlayer.values())
		{
			if (player != null)
			{
				...
				if (DMConfig.DM_EVENT_ON_KILL.equalsIgnoreCase("title") || DMConfig.DM_EVENT_ON_KILL.equalsIgnoreCase("pmtitle"))
				{
					ThreadPool.schedule(new Runnable()
					{
						...
						{
						//	if (DMConfig.ENABLE_DM_INSTANCE)
						//		player.getPlayer().setInstanceId(0, true);

							player.getPlayer().clearDMPoints();
						}
					}, DMConfig.DM_EVENT_START_LEAVE_TELEPORT_DELAY * 1000);
				}
			}
		}
	...
	{
		CreatureSay cs = new CreatureSay(0, Say2.PARTY, "DM Manager", message);
	...
	//	{
		...
		//	activeChar.setInstanceId(DMConfig.DM_INSTANCE_ID, true);
	//	}
	...
	public static void onKill(Creature killerCharacter, Player killedPlayerInstance)
	{
		...
		if (isPlayerParticipant(killerPlayerInstance))
		{
			...
			if (DMConfig.DM_EVENT_ON_KILL.equalsIgnoreCase("pm"))
			{
				sysMsgToAllParticipants(killerPlayerInstance.getName() + " Hunted Player " + killedPlayerInstance.getName() + "!");
			}
			else if (DMConfig.DM_EVENT_ON_KILL.equalsIgnoreCase("title"))
			{
				killerPlayerInstance.increaseDMPointScore();
				killerPlayerInstance.broadcastCharInfo();
				//killerPlayerInstance.setTitle("Kills: " + killerPlayerInstance.getDMPointScore());
				//killerPlayerInstance.broadcastTitleInfo();
			}
			else if (DMConfig.DM_EVENT_ON_KILL.equalsIgnoreCase("pmtitle"))
			{
				sysMsgToAllParticipants(killerPlayerInstance.getName() + " Hunted Player " + killedPlayerInstance.getName() + "!");
				killerPlayerInstance.increaseDMPointScore();
				killerPlayerInstance.broadcastCharInfo();
