	...
	private class Pair
	{
		...
		//		assist3.getAppearance().setInvisible();
			...
			//	assist5.getAppearance().setInvisible();
				...
				assist5.setTeamTour1(false);
				assist5.setTeamTour2(false);
				/*
			...
			//	assist6.getAppearance().setInvisible();
				...
				assist6.setTeamTour1(false);
				assist6.setTeamTour2(false);
				/*
			...
			//	assist7.getAppearance().setInvisible();
				...
				assist7.setTeamTour1(false);
				assist7.setTeamTour2(false);
				/*
		...
		//		assist8.getAppearance().setInvisible();
				...
				assist8.setTeamTour1(false);
				assist8.setTeamTour2(false);
				/*
...
//		}
		...
		public void setArenaInstance(InstanceHolder instance) 
		{
			...
			if (leader != null && leader.isOnline())
				leader.setInstance(instance, true); //9x9 Tournament Instance
			
			if (assist != null && assist.isOnline())
				assist.setInstance(instance, true); //9x9 Tournament Instance
			
			if (assist2 != null && assist2.isOnline())
				assist2.setInstance(instance, true); //9x9 Tournament Instance
			
			if (assist3 != null && assist3.isOnline())
				assist3.setInstance(instance, true); //9x9 Tournament Instance
			
			if (assist4 != null && assist4.isOnline())
				assist4.setInstance(instance, true); //9x9 Tournament Instance
			
			if (assist5 != null && assist5.isOnline())
				assist5.setInstance(instance, true); //9x9 Tournament Instance
			
			if (assist6 != null && assist6.isOnline())
				assist6.setInstance(instance, true); //9x9 Tournament Instance
			
			if (assist7 != null && assist7.isOnline())
				assist7.setInstance(instance, true); //9x9 Tournament Instance
			
			if (assist8 != null && assist8.isOnline())
				assist8.setInstance(instance, true); //9x9 Tournament Instance
		}
		...
		public void setRealInstance() 
		{
			...
			if (assist5 != null && assist5.isOnline())
				assist5.setInstance(instance, true);
			
			if (assist6 != null && assist6.isOnline())
				assist6.setInstance(instance, true);
			
			if (assist7 != null && assist7.isOnline())
				assist7.setInstance(instance, true);
			
			if (assist8 != null && assist8.isOnline())
				assist8.setInstance(instance, true);
		}
		...
		public void rewards()
		{
			...
			{
				if (leader.isVip())
					leader.addItem("Arena_Event", ArenaConfig.ARENA_REWARD_ID, (int) (ArenaConfig.ARENA_WIN_REWARD_COUNT_9X9 * Config.VIP_DROP_RATE), leader, true);
				else
			...
			{
				if (assist.isVip())
					assist.addItem("Arena_Event", ArenaConfig.ARENA_REWARD_ID, (int) (ArenaConfig.ARENA_WIN_REWARD_COUNT_9X9 * Config.VIP_DROP_RATE), assist, true);
				else
			...
			{
				if (assist2.isVip())
					assist2.addItem("Arena_Event", ArenaConfig.ARENA_REWARD_ID, (int) (ArenaConfig.ARENA_WIN_REWARD_COUNT_9X9 * Config.VIP_DROP_RATE), assist2, true);
				else
			...
			{
				if (assist3.isVip())
					assist3.addItem("Arena_Event", ArenaConfig.ARENA_REWARD_ID, (int) (ArenaConfig.ARENA_WIN_REWARD_COUNT_9X9 * Config.VIP_DROP_RATE), assist3, true);
				else
			...
			{
				if (assist4.isVip())
					assist4.addItem("Arena_Event", ArenaConfig.ARENA_REWARD_ID, (int) (ArenaConfig.ARENA_WIN_REWARD_COUNT_9X9 * Config.VIP_DROP_RATE), assist4, true);
				else
			...
			{
				if (assist5.isVip())
					assist5.addItem("Arena_Event", ArenaConfig.ARENA_REWARD_ID, (int) (ArenaConfig.ARENA_WIN_REWARD_COUNT_9X9 * Config.VIP_DROP_RATE), assist5, true);
				else
			...
			{
				if (assist6.isVip())
					assist6.addItem("Arena_Event", ArenaConfig.ARENA_REWARD_ID, (int) (ArenaConfig.ARENA_WIN_REWARD_COUNT_9X9 * Config.VIP_DROP_RATE), assist6, true);
				else
			...
			{
				if (assist7.isVip())
					assist7.addItem("Arena_Event", ArenaConfig.ARENA_REWARD_ID, (int) (ArenaConfig.ARENA_WIN_REWARD_COUNT_9X9 * Config.VIP_DROP_RATE), assist7, true);
				else
			...
			{
				if (assist8.isVip())
					assist8.addItem("Arena_Event", ArenaConfig.ARENA_REWARD_ID, (int) (ArenaConfig.ARENA_WIN_REWARD_COUNT_9X9 * Config.VIP_DROP_RATE), assist8, true);
				else
		...
		public void rewardsLost()
		{
			...
			{
				if (leader.isVip())
					leader.addItem("Arena_Event", ArenaConfig.ARENA_REWARD_ID, (int) (ArenaConfig.ARENA_LOST_REWARD_COUNT_9X9 * Config.VIP_DROP_RATE), leader, true);
				else
			...
			{
				if (assist.isVip())
					assist.addItem("Arena_Event", ArenaConfig.ARENA_REWARD_ID, (int) (ArenaConfig.ARENA_LOST_REWARD_COUNT_9X9 * Config.VIP_DROP_RATE), assist, true);
				else
			...
			{
				if (assist2.isVip())
					assist2.addItem("Arena_Event", ArenaConfig.ARENA_REWARD_ID, (int) (ArenaConfig.ARENA_LOST_REWARD_COUNT_9X9 * Config.VIP_DROP_RATE), assist2, true);
				else
			...
			{
				if (assist3.isVip())
					assist3.addItem("Arena_Event", ArenaConfig.ARENA_REWARD_ID, (int) (ArenaConfig.ARENA_LOST_REWARD_COUNT_9X9 * Config.VIP_DROP_RATE), assist3, true);
				else
			...
			{
				if (assist4.isVip())
					assist4.addItem("Arena_Event", ArenaConfig.ARENA_REWARD_ID, (int) (ArenaConfig.ARENA_LOST_REWARD_COUNT_9X9 * Config.VIP_DROP_RATE), assist4, true);
				else
			...
			{
				if (assist5.isVip())
					assist5.addItem("Arena_Event", ArenaConfig.ARENA_REWARD_ID, (int) (ArenaConfig.ARENA_LOST_REWARD_COUNT_9X9 * Config.VIP_DROP_RATE), assist5, true);
				else
			...
			{
				if (assist6.isVip())
					assist6.addItem("Arena_Event", ArenaConfig.ARENA_REWARD_ID, (int) (ArenaConfig.ARENA_LOST_REWARD_COUNT_9X9 * Config.VIP_DROP_RATE), assist6, true);
				else
			...
			{
				if (assist7.isVip())
					assist7.addItem("Arena_Event", ArenaConfig.ARENA_REWARD_ID, (int) (ArenaConfig.ARENA_LOST_REWARD_COUNT_9X9 * Config.VIP_DROP_RATE), assist7, true);
				else
			...
			{
				if (assist8.isVip())
					assist8.addItem("Arena_Event", ArenaConfig.ARENA_REWARD_ID, (int) (ArenaConfig.ARENA_LOST_REWARD_COUNT_9X9 * Config.VIP_DROP_RATE), assist8, true);
				else
	...
	//		free++;
		...
		private void rewardWinner()
		{
			if (pairOne.isAlive() && !pairTwo.isAlive())
			{
				...
				if (leader1.getClan() != null && leader2.getClan() != null && ArenaConfig.TOURNAMENT_EVENT_ANNOUNCE)
					Broadcast.gameAnnounceToOnlinePlayers("[ 9X9 ]: [" + leader1.getClan().getName() + " VS " + leader2.getClan().getName() + "] ~> " + leader1.getClan().getName() + " WINS!");
		...
		/*private void portPairsToArena(Instance instace)
		{
			int id=1;
			int[] coord = ArenaConfig.ARENA_EVENT_LOCS_9X9[0];
			Arena arena = new Arena(id, coord[0], coord[1], coord[2]);
				
					pairOne.removePet();
					pairTwo.removePet();
					pairOne.setArenaInstance(instace);
					pairTwo.setArenaInstance(instace);
		...
		private void portPairsToArena1(Instance instace)
		{
			for (Arena arena : arenas)
			{
				if (arena.isFree)
