...
import net.sf.l2j.hwid.crypt.FirstKey;

public class HwidConfig
{
	protected static Logger	_log = Logger.getLogger(HwidConfig.class.getName());
	public static final String D_GUARD_FILE = "./config/ProtectGuard.properties";
	...
	public static int PROTECT_WINDOWS_COUNT = 0;
	...
	public static boolean PROTECT_KICK_WITH_LASTERROR_HWID;
	  ...
	  {
		  File fp = new File("./config/ProtectGuard.properties");
