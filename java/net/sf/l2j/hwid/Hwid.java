...
import net.sf.l2j.hwid.crypt.BlowfishEngine;
import net.sf.l2j.hwid.crypt.Manager;
import net.sf.l2j.hwid.hwidmanager.HWIDManager;
import net.sf.l2j.hwid.utils.Util;
...
public class Hwid
{
	...
	public static void Init()
	{
		...
		StringUtil.printSection("ProtectGuard");
	...
	{
		byte[] bfkey = {11, 22, 33, 15, -5, 17, 24, 23, 18, 45, 1, 21, 122, 16, -5, 12};
		try
		{
