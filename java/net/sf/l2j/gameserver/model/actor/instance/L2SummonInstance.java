...
public class L2SummonInstance extends L2Summon
{
	...
	public L2SummonInstance(int objectId, NpcTemplate template, Player owner, L2Skill skill)
	{
	...
	public boolean doDie(Creature killer)
	{
		...
		for (Attackable mob : getKnownList().getKnownType(Attackable.class))
		{
			if (mob.isDead())
				continue;
	...
	static class SummonLifetime implements Runnable
	{
		...
		SummonLifetime(Player activeChar, L2SummonInstance newpet)
		{
