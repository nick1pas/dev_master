...
public class L2PetInstance extends L2Summon
{
	...
	public synchronized static L2PetInstance spawnPet(NpcTemplate template, Player owner, ItemInstance control)
	{
	...
	public L2PetInstance(int objectId, NpcTemplate template, Player owner, ItemInstance control)
	{
	...
	private static L2PetInstance restore(ItemInstance control, NpcTemplate template, Player owner)
	{
		try (Connection con = ConnectionPool.getConnection())
		{
			L2PetInstance pet;
