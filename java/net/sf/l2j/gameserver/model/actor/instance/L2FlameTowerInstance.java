...
public class L2FlameTowerInstance extends L2Npc
{
	...
	{
		// Attackable during siege by attacker only
		return (attacker != null && attacker instanceof Player && getCastle() != null && getCastle().getSiege().isInProgress() && getCastle().getSiege().checkIsAttacker(((Player) attacker).getClan()));
	}
