...
public abstract class L2Summon extends Playable
{
	...
	public L2Summon(int objectId, NpcTemplate template, Player owner)
	{
...
//			}
	...
	{
		for (Player player : getOwner().getKnownList().getKnownType(Player.class))
