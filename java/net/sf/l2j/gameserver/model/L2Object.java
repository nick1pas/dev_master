...
public abstract class L2Object
{
	...
	{
		if (!(this instanceof L2Npc) && !(this instanceof Player))
			return false;
	...
	/** instance system */
	private InstanceHolder _instance = InstanceManager.getInstance().getInstance(0);
	
	public void setInstance(InstanceHolder instance, boolean silent)
	{
		_instance = instance;
	...
	public int distance3D(L2Object target)
	{
		if (target == null)
			return Integer.MAX_VALUE;
		
		final int dx = getX() - target.getX();
		final int dy = getY() - target.getY();
		final int dz = getZ() - target.getZ();
		
		return (int) Math.sqrt(dx * dx + dy * dy + dz * dz);
	}
	public int distance3DSq(L2Object target)
	{
		if (target == null)
			return Integer.MAX_VALUE;
