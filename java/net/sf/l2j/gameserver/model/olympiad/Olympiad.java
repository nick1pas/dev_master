...
//	}
	...
	private void load()
	{
	    ...
	    if (!loaded)
	    {
	        _log.log(Level.INFO, "Olympiad: Failed to load data from database, default values are being used.");
	    ...
	    synchronized (this)
	    {
	        ...
	        _log.info("Olympiad: " + Math.round(milliToEnd / 60000) + " minutes until the period ends.");
