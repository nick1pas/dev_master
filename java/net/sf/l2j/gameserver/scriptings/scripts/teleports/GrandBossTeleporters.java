...
import net.sf.l2j.gameserver.scriptings.scripts.ai.individual.Antharas;
import net.sf.l2j.gameserver.scriptings.scripts.ai.individual.Baium;
import net.sf.l2j.gameserver.scriptings.scripts.ai.individual.Sailren;
import net.sf.l2j.gameserver.scriptings.scripts.ai.individual.Valakas;
	...
	public String onAdvEvent(String event, L2Npc npc, Player player)
	{
		...
		else if (event.equalsIgnoreCase("31540"))
		{
			if (st.hasQuestItems(Config.QUEST_VALAKAS))
			{
				...
				player.teleToLocation(190472, -107624, -1016, 0);
				st.set("allowEnter", "1");
			}
			else
