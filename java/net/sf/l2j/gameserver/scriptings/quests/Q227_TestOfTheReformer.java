package net.sf.l2j.gameserver.scriptings.quests;
...
public class Q227_TestOfTheReformer extends Quest
{
	...
	private static L2Npc _olMahumInspector;
	private static L2Npc _olMahumPilgrim;
	private static L2Npc _olMahumBetrayer;
	...
	public String onAttack(L2Npc npc, Player attacker, int damage, boolean isPet, L2Skill skill)
	{
		...
		switch (npc.getNpcId())
		{
			...
			case CRIMSON_WEREWOLF:
				if (cond == 12 && !npc.isScriptValue(1) && (skill == null || !Util.contains(ALLOWED_SKILLS, skill.getId())))
				{
					npc.setScriptValue(1);
