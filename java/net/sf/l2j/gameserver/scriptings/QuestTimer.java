...
public class QuestTimer
{
	...
	public QuestTimer(Quest quest, String name, L2Npc npc, Player player, long time, boolean repeating)
	{
		_quest = quest;
		_name = name;
		_npc = npc;
	 ...
	 * @return boolean
	 */
	public final boolean equals(Quest quest, String name, L2Npc npc, Player player)
	{
