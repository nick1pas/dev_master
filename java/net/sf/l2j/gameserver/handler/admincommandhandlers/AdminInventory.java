...
public class AdminInventory implements IAdminCommandHandler
{
	...
	private static void showItemsPage(Player activeChar, int page)
	{
		...
		for (int i = itemsStart; i < itemsEnd; i++)
		{
			...
			sbItems.append("<td><button action=\"bypass -h admin_delete_item " + items[i].getObjectId() + "\" width=16 height=16 back=\"L2UI_ch3.FrameCloseOnBtn\" fore=\"L2UI_ch3.FrameCloseOnBtn\"></td></tr>");
		}
