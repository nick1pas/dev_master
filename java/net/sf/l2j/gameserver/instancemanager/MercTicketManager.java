 ...
 * <br>
 * These tickets (aka badges) need to be readed after each server reboot except when the server crashed in the middle of an ongoig siege. In addition, this class keeps track of the added tickets, in order to properly limit the number of mercenaries in each castle and the number of mercenaries from
 * each mercenary type.<br>
 * <br>
 * Finally, we provide auxilary functions to identify the castle in which each item (and its corresponding NPC) belong to, in order to help avoid mixing them up.
...
public class MercTicketManager
{
	 ...
	 */
	public static int getTicketCastleId(int itemId)
	{
	...
	/**
	 * @param itemId The ticket id to make checks on.
	 ...
	 * <li>create a copy of the item to drop in the world returns the id of the mercenary npc that was added to the spawn returns -1 if this fails.</li>
	 * </ul>
	 * @param itemId
	 * @param activeChar
	 * @return
