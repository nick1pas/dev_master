...
public class FourSepulchersManager
{
	...
	public synchronized void tryEntry(L2Npc npc, Player player)
	{
	...
	public void spawnMonster(int npcId)
	{
		...
		if (monsterList != null)
		{
			...
			for (L2Spawn spawn : monsterList)
			{
				...
				if (spawnKeyBoxMob)
				{
					try
					{
						...
						if (template != null)
						{
							...
							mob = (L2SepulcherMonsterInstance) keyBoxMobSpawn.doSpawn(false);
				...
				{
					mob = (L2SepulcherMonsterInstance) spawn.doSpawn(false);
					spawn.setRespawnState(false);
				}
	...
	public void spawnArchonOfHalisha(int npcId)
	{
		...
		if (monsterList != null)
		{
			for (L2Spawn spawn : monsterList)
			{
				L2SepulcherMonsterInstance mob = (L2SepulcherMonsterInstance) spawn.doSpawn(false);
				spawn.setRespawnState(false);
	...
	public void showHtmlFile(Player player, String file, L2Npc npc, Player member)
	{
