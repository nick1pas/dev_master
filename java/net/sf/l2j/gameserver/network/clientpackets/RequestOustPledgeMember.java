...
public final class RequestOustPledgeMember extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		clan.removeClanMember(member.getObjectId(), System.currentTimeMillis() + Config.ALT_CLAN_JOIN_DAYS * 60 * 1000L);
		//clan.setCharPenaltyExpiryTime(System.currentTimeMillis() + Config.ALT_CLAN_JOIN_DAYS * 86400000L);
		clan.setCharPenaltyExpiryTime(System.currentTimeMillis() + Config.ALT_CLAN_JOIN_DAYS * 60 * 1000L);
		clan.updateClanInDB();
