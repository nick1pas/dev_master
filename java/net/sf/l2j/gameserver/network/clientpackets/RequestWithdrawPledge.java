...
public final class RequestWithdrawPledge extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		clan.removeClanMember(activeChar.getObjectId(), System.currentTimeMillis() + Config.ALT_CLAN_JOIN_DAYS * 60 * 1000L);
		...
		activeChar.sendMessage("You need Wait " + Config.ALT_CLAN_JOIN_DAYS + " minute(s) to enter in again Clan");
	}
}