...
import net.sf.l2j.log.WharehouseLog;
...
public final class SendWarehouseDepositList extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		for (IntIntHolder i : _items)
		{
			...
			if(Config.ENABLE_WH_LOG)
			{
				WharehouseLog.auditGMAction(player.getName(), warehouse.getName(), oldItem.getObjectId(), oldItem, oldItem.getEnchantLevel());
