...
public final class AllyDismiss extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		leaderClan.setAllyPenaltyExpiryTime(currentTime + Config.ALT_ACCEPT_CLAN_DAYS_WHEN_DISMISSED * 60 * 1000L, L2Clan.PENALTY_TYPE_DISMISS_CLAN);
		...
		clan.setAllyPenaltyExpiryTime(currentTime + Config.ALT_ALLY_JOIN_DAYS_WHEN_DISMISSED * 60 * 1000L, L2Clan.PENALTY_TYPE_CLAN_DISMISSED);
		clan.updateClanInDB();
