...
public class PrivateStoreListSell extends L2GameServerPacket
{
	...
	//	_playerAdena = player.getAdena();
		...
		{
			final String name = ItemTable.getInstance().getTemplate(Config.STORE_SELL_CURRENCY).getName();
			final CreatureSay cs11 = new CreatureSay(0, 15, "ATTENTION", "Private sell is based on "+name+"."); // 8D
