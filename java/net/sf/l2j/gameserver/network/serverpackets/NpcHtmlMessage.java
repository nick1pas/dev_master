...
public final class NpcHtmlMessage extends L2GameServerPacket
{
	...
	public void runImpl()
	{
		...
		if (Config.SHOW_FILE_GM && activeChar.isGM() && _file != null)
		{
		//	activeChar.sendPacket(new CreatureSay(Say2.ALL, "", "HTML", _file));
			activeChar.sendPacket(new CreatureSay(0, Say2.ALL, "", "{HTML}  " + _file));
		}
