...
public class MultisellData extends XMLDocument
{
	...
	protected void load()
	{
		...
		LOGGER.info("Loaded " + _entries.size() + " multisell.");
	}
	 ...
	 * <br>
	 * {@link ListContainer} template is first retrieved, based on its name, then {@link L2Npc} npcId check is done for security reason. Then the content is sent into {@link PreparedListContainer}, notably to check Player inventory. Finally a {@link MultiSellList} packet is sent to the Player. That
	 ...
	 */
	public void separateAndSend(String listName, Player player, L2Npc npc, boolean inventoryOnly)
	{
